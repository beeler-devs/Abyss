...
export class BridgeStateStore {
  ...
  getOnlineDevices(): BridgeDeviceRecord[] {
    return sortDevices(
      [...this.devicesById.values()].filter((device) => device.status === "online"),
    );
  }
...
function sortDevices(devices: BridgeDeviceRecord[]): BridgeDeviceRecord[] {
