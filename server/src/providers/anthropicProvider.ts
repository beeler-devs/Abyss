...
export class AnthropicProvider implements ModelProvider {
  ...
  private buildSystemPrompt(userPreferences?: Record<string, string>, canvasCourseContext?: string): string {
    const parts: string[] = [
      ...
      "If bridge_exec_run or bridge_exec_start tools are available, use them when the user asks to run shell commands, check files, or perform terminal operations on their paired Mac. If bridge_claude_run is available, use it for complex coding/editing tasks on the Mac.",
