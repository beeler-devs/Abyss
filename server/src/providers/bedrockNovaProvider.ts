  ...
  private buildSystemPrompt(): SystemContentBlock[] {
    return [{
      text: [
        ...
        "If bridge.claude.run is available and the user asks to run Claude Code, use Claude Code, or mentions 'cloud code' (likely a speech-to-text mishearing of 'Claude Code'), call bridge.claude.run.",
      ].join(" "),
    }];
  }
