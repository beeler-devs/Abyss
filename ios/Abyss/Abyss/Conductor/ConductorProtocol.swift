...
protocol ConductorClient: Sendable {
    func connect(sessionId: String, githubToken: String?, gmailAccessToken: String?, gmailRefreshToken: String?, gmailTokenExpiresAt: Double?, canvasAccessToken: String?, canvasBaseURL: String?, preferences: [String: String]?) async throws
